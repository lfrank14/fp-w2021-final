...
This is a silly example, but there are many reasons why you would want the function to output a warning or error. For example, you many want the function to warn someone if their input is not going to give them the output they expect, or if the function will not work for certain input. This will help the user work with your function to get their desired output.
...
Okay, now we're ready to generalize. Note
```{r}
