...
The original data files downloaded from the *NHANES* website were separated by year and data type (i.e. demographicss and FSQ), resulting in a number of data files. Rather than loading in each file one at a time, the `purrr::map` family of functions provides powerful tools for loading in large amounts of data. 
