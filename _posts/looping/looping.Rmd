...
The explanation of each step is really clear. One potential improvement could be displaying a part of output after the code of each section, especially for the section you used `nest()` and `unnest()`. I think people would like to know how nested and unnested outputs look like, particularly for beginner. 
