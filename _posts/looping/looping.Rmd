...
For this post, we'll be using data from the [*National Health and Nutrition Examination Survey* (NHANES)](https://www.cdc.gov/nchs/nhanes/index.htm), which provides longitudinal data on health and nutrition in the United States. More information about the dataset is available <a href = "https://lfrank14.github.io/fp-w2021-final/about.html" target="_blank">here</a>.
